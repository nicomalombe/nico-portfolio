...
<section className="about-section">
  ...
  <div className="image-container">
    <img src={educationImg} alt="Education" />
      ...
      {/* Section 3: Technical and Professional Skills */}
      <section className="about-section">
        <div className="image-container">
      ...
      <ul className="skills-list">
        ...
        <li><strong>flameworks</strong> Flask, Django, spring boot, react js, node js</li>
        <li><strong>development tools</strong> vs code, android studio,devc++, unity community</li>
        ...
        <li><strong>Microsoft Office Tools:</strong> Excel, Word, Acess, PowerPoint, Google Workspace</li>
        <li><strong>IT Support:</strong> fiber management, system Troubleshooting, Networking configuration, Software/Hardware Setup, User Support</li>
      </ul>
    </div>
    </div>
      </section>
  ...
  <div className="text-container">
    ...
    <p>
      I have worked on various academic projects involving web design, system development, data science analyisis, AI&ML models,andriod development,database integration,
  ...
  <div className="image-container">
    <img src={experienceImg} alt="Experience" />
      ...
      {/* Section 5: Passion and Interest */}
      <section className="about-section">
        <div className="image-container">
        ...
        <div className="text-container">
          ...
          <p>
            I have a strong passion for emerging technologies, especially AI,machine learning, data science, android development,software development and web development.
